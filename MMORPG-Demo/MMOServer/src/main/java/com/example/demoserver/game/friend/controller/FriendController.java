...
public class FriendController {
    ...
    @RequestMapping(getOrder = Orders.ADDFRIEND)
    public  void friendAdd(ChannelHandlerContext ctx, Msg message) {
    ...
    @RequestMapping(getOrder = Orders.SHOWFRIENDLIST)
    public  void friendList(ChannelHandlerContext ctx, Msg message) {
